...
/**
 * A class that syntax highlights Java code into html.<p>
 *
 * A CodeViewer object is used to syntax highlight Java code. To make use of this class, first set
 * up how tokens should be highlighted by invoking the getXXX and setXXX methods, then pass in
 * "chunks" of relevent input to be filtered. Typically this will mean the section(s) of a form
 * input that has been tagged with [code][/code] tags.
 */
public class JavaCodeViewer {
    ...
    /**
     * Syntax highlights any java code in the input. In working with this method it is helpful to
