 ...
 *
 */
public class BaseAuthTestCase extends AbstractDependencyInjectionSpringContextTests{
...
//	public ParamService paramService;
	...
	protected String[] getConfigLocations() {
        return new String[] { "spring-auth.xml"};
    }
...
//    }
    ...
    public Integer[] str2intArray(String strArray){
